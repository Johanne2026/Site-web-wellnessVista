    ...
    <div className='bg-[#36ae9a] text-white rounded-t-3xl mt-8 md:mt-0'>
      <div className='flex flex-col md:flex-row justify-between p-8 md:px-32 px-5'>
        ...
        <div>
            ...
            <nav className=' flex flex-col gap-2'>
                <Link to='services' spy={true} smooth={true} duration={500} className=' hover:text-[#FFC000] transition-all cursor-pointer'>Lab Test</Link>
                <Link to='services' spy={true} smooth={true} duration={500} className=' hover:text-[#FFC000] transition-all cursor-pointer'>Health Check</Link>
                <Link to='services' spy={true} smooth={true} duration={500} className=' hover:text-[#FFC000] transition-all cursor-pointer'>Heart Health</Link>
            </nav>
        </div>
        <div className='w-full md:w-1/4'>
      ...
      <div>
        <p className='text-center py-4'>
            ...
            <span className='text-[#FFC000]'>champion programmers</span> | All Rights Reserved.
        </p>
      </div>
    </div>
  )
